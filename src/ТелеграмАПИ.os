...
// Превращает опрос в квиз (викторина)
// (Метод sendPoll)
//
// Параметры:
...
//
Функция НовыйОпросКвиз(Опрос) Экспорт
...
//  ПравильныйОтвет  - Булево - Признак правильного ответа (только для опроса в режиме квиз)
//
// Возвращаемое значение:
//   Структура   - Структура, готовая для передачи в ОтправитьОпрос() в классе ТелеграмБот
//
Функция ДобавитьВариантОтветаНаОпрос(Опрос, ВариантОтвета, ПравильныйОтвет = Ложь) Экспорт

	МассивВариантовОтвета = Опрос["options"];

	МассивВариантовОтвета.Добавить(ВариантОтвета);
	
	Если ПравильныйОтвет Тогда
